class SuggestionsController < ApplicationController
  ...
  private
    ...
    def set_suggestion
   @suggestion=Suggestion.where('title like ?',params[:title].gsub('-','%'))[0] rescue nil
    ...
    def suggestion_params
      params.require(:suggestion).permit(:start_at,:end_at,:item_id, :title, :content, :image, :city_id)
    end
end
